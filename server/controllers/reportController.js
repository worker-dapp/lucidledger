...
const { DeployedContract, PaymentTransaction, OracleVerification, JobPosting, Employee, Employer, sequelize } = require('../models');
    ...
    res.json({
      contracts: {
        ...
        dispute_rate: totalContracts > 0
          ? ((disputedCount / totalContracts) * 100).toFixed(1)
          : '0.0',
      },
      payments: {

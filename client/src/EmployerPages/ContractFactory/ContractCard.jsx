...
import { FileText, Edit2, Trash2, Play, MoreVertical, Calendar, DollarSign } from "lucide-react";
...
const ContractCard = ({ contract, onUse, onEdit, onDelete }) => {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow duration-200 relative flex flex-col h-full">
          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h3 className="text-lg font-semibold text-[#0D3B66] line-clamp-2">
                  {contract.name}
                </h3>
              </div>

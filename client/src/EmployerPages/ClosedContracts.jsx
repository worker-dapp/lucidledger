...
const ClosedContracts = () => {
  ...
  useEffect(() => {
    const fetchCompletedJobs = async () => {
      ...
      try {
        ...
        setError("Failed to load completed jobs. Please try again later.");
        setJobs([]);
        setSelectedJob(null);
      } finally {
        setLoading(false);
  ...
  const handleJobClick = (job) => {
    setSelectedJob(job);
    // On mobile screens, this will be handled by modal if needed
    if (window.innerWidth < 1024) {
      // Could add mobile modal here if needed
    }
  };
      ...
      <div className="min-h-[600px] bg-gray-50 overflow-hidden">
        ...
        <div className="grid grid-cols-12 h-full">
          ...
          <div className="col-span-12 lg:col-span-4 bg-gray-100 p-3 sm:p-4 lg:p-6 overflow-y-auto">
            <h2 className="text-lg sm:text-xl font-semibold text-[#0D3B66] mb-3 sm:mb-4">Completed Jobs</h2>
            ...
            {selectedJob ? (
              <div className="space-y-6">
                ...
                <div className="text-sm text-gray-500 text-center pt-4 border-t border-gray-200">
                  Completed on {formatDate(selectedJob.updated_at || selectedJob.created_at)}
                </div>
              </div>
            ) : (
